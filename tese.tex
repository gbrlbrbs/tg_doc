...
\usepackage{placeins}
\usepackage{tikz}
\usetikzlibrary{fit, backgrounds, calc, positioning, shapes.geometric}
\DeclareMathOperator{\logloss}{logloss}
\DeclareMathOperator{\maxmin}{maxmin}
\DeclareMathOperator{\minmax}{minmax}
\newcommand{\acl}[1]{\textcolor{red}{#1}}
...
\bosscourse{Prof.~Dr.}{Marcos Ricardo de Omena Albuquerque Máximo}

% Palavras-Chaves informadas pela Biblioteca -> utilizada na CIP
\kwcip{Aprendizagem (inteligência artificial)}
\kwcip{Redes neurais}
\kwcip{Classificações}
\kwcip{Algoritmos} 
\kwcip{Complexidade computacional}
\kwcip{Dados}
\kwcip{Computação}
% membros da banca examinadora

\examiner{Prof. Dr.}{Carlos}{Presidente}{ITA}
...
% Apendices
\appendix
\chapter{Instance Hardness} \label{ch:instance_hardness} %opcional
...
\FRDitadata{30 de junho de 2023}
\FRDitadocnro{DCTA/ITA/TC-012/2023} %(o número de registro você solicita a biblioteca)
\FRDitaorgaointerno{Instituto Tecnológico de Aeronáutica -- ITA}
%Exemplo no caso de pós-graduação: Instituto Tecnol{\'o}gico de Aeron{\'a}utica -- ITA
\FRDitapalavrasautor{Machine Learning, Neural networks, Instance Space Analysis, Generative models}
\FRDitapalavrasresult{Aprendizagem (inteligência artificial); Redes neurais; Classificações; Algoritmos; Complexidade computacional; Dados; Computação.}
%Exemplo no caso de graduação (TG):
\FRDitapalavraapresentacao{Trabalho de Graduação, ITA, São José dos Campos, 2023. \NumPenultimaPagina\ páginas.}
